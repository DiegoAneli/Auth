    ...
    <div>
      ...
      <div className="min-h-screen flex flex-col md:flex-row">
        <div className="flex-1 flex flex-col items-center justify-center bg-white p-10">
          <h1 className="text-4xl font-bold text-gray-800 mb-6">Benvenuto nella Dashboard</h1>
          <p className="text-lg text-gray-600 mb-8">
            Benvenuto, {session?.user?.name}!
          </p>
          <div className="w-full max-w-2xl">
            <div className="mb-4">
              <h2 className="text-2xl font-bold text-gray-800 mb-2">Sezione 1</h2>
            ...
            <div className="mb-4">
              <h2 className="text-2xl font-bold text-gray-800 mb-2">Sezione 2</h2>
              <p className="text-gray-600 mb-4">
                Questa è una breve descrizione della seconda sezione della tua dashboard.
              </p>
              <button
            ...
            <div className="mb-4">
              <h2 className="text-2xl font-bold text-gray-800 mb-2">Sezione 3</h2>
              <p className="text-gray-600 mb-4">
                Questa è una breve descrizione della terza sezione della tua dashboard.
              </p>
              <button
